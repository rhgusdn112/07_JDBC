...
// 클래스명.메서드명()이 아닌 메서드명() 만 작성해도 호출이 가능하게 함 
...
public class UserService {
	...
	/** 이름에 검색어가 포함된 회원 조회 Service 메서드
	 * @param keyword
	 * @return searchList
	 * @throws Exception
	 */
	...
	public int multiInsertUser(List<User> userList) throws Exception {
		...
		for(User user : userList) {
			...
			count += result; // 삽입 성공한 행의 개수 count 누적
